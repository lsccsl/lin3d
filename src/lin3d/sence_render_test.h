...
*/
#ifndef __L3ENG__SENCE_RENDER_TEST_H__
#define __L3ENG__SENCE_RENDER_TEST_H__
...
class sence_render_test
{
public:

	typedef ref_ptr_thread<sence_render_test> ptr;

	sence_render_test(sence_mgr * sence);
	~sence_render_test(){}
